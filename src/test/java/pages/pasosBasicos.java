...
public class pasosBasicos {
    ...
    protected static final Logger logger = LogManager.getLogger(pasosBasicos.class);
    Map<By, WebElement> elementCache = new HashMap<>();

    // Configuración del WebDriver para Chrome usando WebDriverManager.
    static {
        // estas lineas son para ingreso en modo incognito y asi no genere problema con
        // el login
    ...
    public WebElement encontrar(By locator) {
        try {
            ...
            logger.info("Elemento encontrado: " + locator.toString());
            return elemento;
        } catch (Exception e) {
